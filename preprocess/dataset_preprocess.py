...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Swin-MSTP for Continuous Sign Language Recognition.')
    parser.add_argument('--dataset', type=str, default='phoenix2014',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='/home/sarah_alyami/Documents/Datasets/phoenix2014-release/phoenix-2014-multisigner ',) #change dataset root 
    ...
    for md in mode:
        # CHANGE DATASET ROOT
        anno_path = f"/home/sarah_alyami/Documents/Datasets/phoenix2014-release/phoenix-2014-multisigner/annotations/manual/{md}.corpus.csv"
        information = csv2dict(anno_path, dataset_type=md)
        print(md)
       # print(information)
        ...
        generate_gt_stm(information, f"../evaluation/slr_eval/{args.dataset}-groundtruth-{md}.stm")
        # resize images
